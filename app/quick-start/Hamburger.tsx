    ...
    return (
        <div className="hamburger-menu">
            ...
            <ul className="menu__box">
                ...
                <li><a className="menu__item" href="/quick-start/readonly-atoms">Read Only Atoms</a></li>
                <li><a className="menu__item" href="/quick-start/write-only-atoms">Write Only Atoms</a></li>
                <li><a className="menu__item" href="/quick-start/read-write-atoms">Read Write Atoms</a></li>
