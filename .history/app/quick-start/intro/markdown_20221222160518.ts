...
The atom we created is to be passed to useState useAtom returns an array of size 2, where the 1st element is a value and the 2nd element is a function, to set the value of the atom.
`